...
train_tumor_gt_path = '/media/margery/4ABB9B07DF30B9DB/pythonDemo/tools/prepare_detection_dataset/train_tumor_whole'
train_wall_gt_path = '/media/margery/4ABB9B07DF30B9DB/pythonDemo/tools/prepare_detection_dataset/train_wall_whole'
test_tumor_gt_path = '/media/margery/4ABB9B07DF30B9DB/pythonDemo/tools/prepare_detection_dataset/test_tumor_whole'
test_wall_gt_path = '/media/margery/4ABB9B07DF30B9DB/pythonDemo/tools/prepare_detection_dataset/test_wall_whole'
    ...
    for ID in os.listdir(nii_path):
        # if int(ID) >= 1000067:
            ...
            for i in range(data_arr.shape[0]):
                ...
                cv2.imwrite(os.path.join(train_wall_gt_path, ID[:-7] + '-' + index + '.png'), img)
                num += 1
